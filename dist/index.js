...
function omit(object, keysToOmit) {
  return Object.keys(object).filter((option) => !keysToOmit.includes(option)).reduce((obj, key2) => {
      ...
      if (modifier === "*") {
        if (Array.isArray(value2)) {
          value2.filter(isDefined).forEach(function(value3) {
            result.push(encodeValue(operator, value3, isKeyOperator(operator) ? key2 : ""));
          });
        } else {
  ...
  "node_modules/node-fetch/lib/index.mjs"() {
    ...
    Headers = class {
        ...
        if (init == null)
          ...
          if (method != null) {
            ...
            for (const key2 of Object.keys(init)) {
              const value2 = init[key2];
              this.append(key2, value2);
            }
          }
        } else {
      ...
      set(name, value2) {
        ...
        const key2 = find(this[MAP], name);
        this[MAP][key2 !== void 0 ? key2 : name] = [value2];
      }
      append(name, value2) {
        name = `${name}`;
        value2 = `${value2}`;
...
function graphql(request2, query, options) {
  ...
  const requestOptions = Object.keys(parsedOptions).reduce((result, key2) => {
...
var require_dist_node = __commonJS({
  "node_modules/@octokit/auth-action/dist-node/index.js"(exports) {
    ...
    var authToken = (init_dist_web7(), __toCommonJS(dist_web_exports));
...
var VERSION5, composePaginateRest, paginatingEndpoints;
...
var require_dist_node2 = __commonJS({
  "node_modules/@octokit/action/dist-node/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var core = (init_dist_web8(), __toCommonJS(dist_web_exports2));
    var authAction = require_dist_node();
    var pluginPaginateRest = (init_dist_web9(), __toCommonJS(dist_web_exports3));
    var pluginRestEndpointMethods = (init_dist_web10(), __toCommonJS(dist_web_exports4));
    var VERSION7 = "4.0.8";
    ...
    var Octokit3 = core.Octokit.plugin(pluginPaginateRest.paginateRest, pluginRestEndpointMethods.legacyRestEndpointMethods).defaults(function buildDefaults(options) {
      return {
        ...DEFAULTS2,
        ...options,
        request: {
...
var require_file_command = __commonJS({
  "node_modules/@actions/core/lib/file-command.js"(exports) {
    ...
    function prepareKeyValueMessage(key2, value2) {
      const delimiter = `ghadelimiter_${uuid_1.v4()}`;
      const convertedValue = utils_1.toCommandValue(value2);
      ...
      _processResponse(res, options) {
        return __awaiter(this, void 0, void 0, function* () {
          return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            function dateTimeDeserializer(key2, value2) {
              if (typeof value2 === "string") {
  ...
  "node_modules/@actions/core/lib/summary.js"(exports) {
    ...
    var Summary = class {
      ...
      wrap(tag, content, attrs = {}) {
        const htmlAttrs = Object.entries(attrs).map(([key2, value2]) => ` ${key2}="${value2}"`).join("");
        if (!content) {
...
Support boolean input list: \`true | True | TRUE | false | False | FALSE\``);
    ...
    function saveState(name, value2) {
      ...
      command_1.issueCommand("save-state", { name }, utils_1.toCommandValue(value2));
    }
...
var main = async () => {
  ...
  if (value) {
    ...
    await octokit.graphql(`
            mutation {
              minimizeComment(input: {classifier: OFF_TOPIC, subjectId: "${updated == null ? void 0 : updated.data.node_id}"}) {
                minimizedComment {
                  isMinimized
                }
              }
